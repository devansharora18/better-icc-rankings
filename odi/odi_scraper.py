...
countries = ['South Africa', 'Netherlands', 'Sri Lanka', 'Nepal', 'Papua New Guinea', 'England', 'West Indies', 'United States of America', 'India', 'Canada', 'Afghanistan', 'United Arab Emirates', 'Pakistan', 'Australia', 'Jersey', 'Hong Kong', 'New Zealand', 'Oman', 'Bangladesh', 'Namibia', 'Bermuda', 'Zimbabwe', 'Ireland', 'Scotland', 'Kenya']

cities = ['Kimberley', 'Khulna', 'Nagpur', 'Manchester', 'Mumbai', 'North Sound', 'King City', 'Kolkata', 'Benoni', 'Tarouba', 'East London', 'Gqeberha', 'Dhaka', 'Kingston', 'St Kitts', 'Kandy', 'Chattogram', 'Port of Spain', 'Providence', 'Hambantota', 'Cardiff', 'Durban', 'Raipur', 'Dubai', 'Delhi', 'Jamshedpur', 'Hyderabad', 'Harare', 'Townsville', 'Taunton', 'Edinburgh', 'Barbados', 'Queenstown', 'Glasgow', 'Sind', 'Kirtipur', 'Canterbury', 'Pearland', 'Greater Noida', 'Christchurch', 'Aberdeen', 'Ahmedabad', 'Bready', 'Kuala Lumpur', 'Paarl', 'Dunedin', 'Trinidad', 'Mirpur', 'Cairns', 'Leeds', 'Antigua', 'Abu Dhabi', 'Gwalior', 'Southampton', 'Colombo', 'Perth', 'Faisalabad', 'Lucknow', 'Bristol', 'Kochi', 'Bulawayo', 'St Vincent', 'Dharamsala', 'Port Elizabeth', 'Bogra', 'Pune', 'Grenada', 'Visakhapatnam', 'Sydney', 'Sharjah', 'Centurion', 'Nottingham', 'Guwahati', 'Dambulla', 'Unknown', 'Chandigarh', 'Cuttack', 'Deventer', 'Chittagong', 'Rawalpindi', 'Chester-le-Street', 'Faridabad', 'Melbourne', 'Chelmsford', 'Dominica', 'Windhoek', 'Brisbane', 'St Lucia', 'London', 'Hong Kong', 'Jamaica', 'Bangalore', 'Gros Islet', 'Johannesburg', 'Adelaide', 'Birmingham', 'Doha', 'Whangarei', 'Peshawar', 'Mount Maunganui', 'Lahore', 'Kathmandu', 'Nelson', 'Al Amarat', 'Multan', 'Napier', 'Nairobi', 'Cape Town', 'Dublin', 'Lincoln', 'Amstelveen', 'Ayr', 'Kanpur', 'Lauderhill', 'Fatullah', 'Rajkot', 'Vadodara', 'Bengaluru', 'Belfast', 'Guyana', 'Hobart', 'Bloemfontein', 'Sylhet', 'Darwin', 'Auckland', 'Potchefstroom', 'Chennai', 'Rotterdam', 'Jaipur', 'Toronto', 'Bridgetown', 'Thiruvananthapuram', 'Indore', 'Wellington', 'Utrecht', 'Karachi', 'Canberra', 'Margao', 'Kingstown', 'Ranchi', 'Pietermaritzburg', 'Hamilton', "St George's", 'Dharmasala', 'Dehra Dun', 'Port Moresby']
